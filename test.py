...
with tab1:
    ...
    st.markdown(
    "<h3 style='text-align: center; color: green;'>Every day, the world generates millions of tons of waste, and India alone contributes over 277 million tons annually...</h3>",
    unsafe_allow_html=True)

    st.markdown(
    "<h3 style='text-align: center; color: green;'>At EcoScan, we are committed to addressing this issue with cutting-edge technology...</h3>",
    unsafe_allow_html=True
)
